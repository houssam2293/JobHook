	...
	@csrf
			...
			<div class="detail-desc section">
				<div class="container white-shadow">
					...
					<div class="row bottom-mrg">
							...
							<div class="col-md-6 col-sm-6">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Location,e.g. London Quel Mark" name="lieu">
					...
					<div class="row no-padd">
						<div class="detail pannel-footer">
							<div class="col-md-12 col-sm-12">
								<div class="detail-pannel-footer-btn pull-right" nmae="cover">
			...
			<section class="full-detail">
				<div class="container">
					<div class="row bottom-mrg extra-mrg">
						...
						<div class="col-md-6 col-sm-6">
							<div class="input-group">
								<label for="duree">Annee D'experience Requis (Max=30):</label>
							</div>
								<div class="input-group">
										<input type="number" name="anneeExperience" min="0" max="30">
									</div>
						</div>

						<div class="col-md-6 col-sm-6">
								<div class="input-group">
									<label for="duree">Date de Debut:</label>
								</div>
								<div class="input-group">
									<input type="text" name="dateDebut" id="company-dob" data-lang="en" data-large-mode="true" data-min-year="<?php
         echo date('Y');
     ?>" data-max-year="2030" data-disabled-days="08/17/2017,08/18/2017" data-id="datedropper-0" data-theme="my-style" class="form-control" readonly="">
					...
					<div class="row bottom-mrg extra-mrg">
							...
							<div class="col-md-12 col-sm-12">
								<textarea class="form-control" placeholder="Job Requirement" name="diplomeRequis"></textarea>
